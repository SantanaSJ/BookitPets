...
public class AccommodationServiceImpl implements AccommodationService {
    ...
    public AccommodationServiceImpl(AccommodationRepository accommodationRepository, AccommodationTypeRepository accommodationTypeRepository, RoomRepository roomRepository,
    ...
    public void initHotels() {
        if (this.accommodationRepository.count() == 0 && this.roomRepository.count() == 0) {
            ...
            accommodationEntity1
                    ...
                    .setPostalCode(1000)
                    .setType(this.accommodationTypeRepository.findByType(AccommodationTypeEnum.HOTEL))
            ...
            accommodationEntity6
                    ...
                    .setPostalCode(1606)
                    .setType(this.accommodationTypeRepository.findByType(AccommodationTypeEnum.HOSTEL))
                    .setCheckInTime(LocalTime.of(15, 0))
                    .setCheckOutTime(LocalTime.of(12, 0))
