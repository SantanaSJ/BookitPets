# # INSERT INTO property_types (id, type)
# # VALUES (1, 'hotel'),
# #         (2, 'villa'),
# #         (3, 'hostel'),
# #         (4, 'apartment'),
...
#
#
# INSERT INTO properties (id, address, category, city, image_url, name, postal_code, type_id, check_in_time, check_out_time, description, lat, lng)
...
#         and a buffet breakfast is available in the Barillon 1909 restaurant from 07:00 to 10:00.', '42.6809944', '23.3986898'),
...
#         Complimentary coffee and tea facilities, as well as a business center with copy machine are at guests disposal.', '42.68948', '23.32049'),
...
#         An airport shuttle service is available on request and for a surcharge.', '42.708236', '23.322257'),
...
#         a sauna, a steam bath and a relax zone. Guests can enjoy a meal at the on site restaurant. Free WiFi is at guests disposal. Shuttle services can be organized upon request and at a surcharge.','42.6981', '23.3157'),
...
#         A communal washing machine and dryer are available, while lockers are provided in the dormitory rooms. Hairdryer and ironing facilities are upon request.', '42.6948', '23.3147'),
...
#         The Budapest Restaurant serves buffet and à la carte dishes. Guests can choose among modern Bulgarian and Hungarian cuisine. In the lobby bar there is a wide range of refreshments, cocktails, snacks and desserts on offer.', '42.7075', '23.3266'),
...
#         It offers large rooms, free Wi-Fi and free indoor parking. The National Theatre, the Bulgarian National bank and all government institutions are just a few steps away from the Grand Hotel Sofia. The closest metro station is a 5-minute walk away.', '42.6940', '23.3248'),
...
#         Panoramic city views can be enjoyed from all rooms.', '42.6570', '23.3828');
#
#
